...
import com.venusource.app.qywechat.api.WxCpMenuService;
...
public class WxCpMenuServiceImpl implements WxCpMenuService {
  ...
  public void create(Integer agentId, WxMenu menu) throws WxErrorException {
    String url = this.mainService.getWxCpConfigStorage().getWxworkServer() + "/cgi-bin/menu/create?agentid=" + agentId;
  ...
  public void delete(Integer agentId) throws WxErrorException {
    String url = this.mainService.getWxCpConfigStorage().getWxworkServer() + "/cgi-bin/menu/delete?agentid=" + agentId;
  ...
  public WxMenu get(Integer agentId) throws WxErrorException {
    String url = this.mainService.getWxCpConfigStorage().getWxworkServer() + "/cgi-bin/menu/get?agentid=" + agentId;
    try {
