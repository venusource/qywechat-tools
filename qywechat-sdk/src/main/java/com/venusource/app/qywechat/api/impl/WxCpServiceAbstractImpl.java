...
import com.venusource.app.qywechat.api.*;
import com.venusource.app.qywechat.base.bean.WxJsapiSignature;
...
import com.venusource.app.qywechat.base.session.WxSession;
import com.venusource.app.qywechat.base.session.WxSessionManager;
import com.venusource.app.qywechat.base.util.DataUtils;
import com.venusource.app.qywechat.base.util.RandomUtils;
import com.venusource.app.qywechat.base.util.crypto.SHA1;
...
import com.venusource.app.qywechat.bean.*;
...
public abstract class WxCpServiceAbstractImpl<H, P> implements WxCpService, RequestHttp<H, P> {
  ...
  public String getJsapiTicket(boolean forceRefresh) throws WxErrorException {
    ...
    if (this.configStorage.isJsapiTicketExpired()) {
      synchronized (this.globalJsapiTicketRefreshLock) {
        if (this.configStorage.isJsapiTicketExpired()) {
          String url = this.configStorage.getWxworkServer() + "/cgi-bin/get_jsapi_ticket";
  ...
  public WxCpMessageSendResult messageSend(WxCpMessage message) throws WxErrorException {
    String url = this.configStorage.getWxworkServer() + "/cgi-bin/message/send";
  ...
  public String[] getCallbackIp() throws WxErrorException {
    String url = this.configStorage.getWxworkServer() + "/cgi-bin/getcallbackip";
  ...
  public String replaceParty(String mediaId) throws WxErrorException {
    String url = this.configStorage.getWxworkServer() + "/cgi-bin/batch/replaceparty";
  ...
  public String replaceUser(String mediaId) throws WxErrorException {
    String url = this.configStorage.getWxworkServer() + "/cgi-bin/batch/replaceuser";
    JsonObject jsonObject = new JsonObject();
    jsonObject.addProperty("media_id", mediaId);
    return post(url, jsonObject.toString());
  }
  ...
  public String getTaskResult(String joinId) throws WxErrorException {
    String url = this.configStorage.getWxworkServer() + "/cgi-bin/batch/getresult?jobid=" + joinId;
    return get(url, null);
  }
